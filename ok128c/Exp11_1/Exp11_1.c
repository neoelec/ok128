/* ========================================================================== */
/*                  Exp11_1.c : AT93C56 Read/Write using SPI                  */
/* ========================================================================== */
...
unsigned char AT93C56_READ(unsigned char address)
{                                              /* read a byte */
  ...
  return (upper << 1) + (lower >> 7);          // return data
}

void AT93C56_WRITE(unsigned char address, unsigned char byte)
{                                              /* write a byte */
  PORTB = 0x01;                                // CS = 1
  SPDR = 0x0A;                                 // 0000 1010
  while ((SPSR & 0x80) == 0x00) ;              // transmit complete ?
