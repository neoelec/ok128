...
SIGNAL(SIG_INTERRUPT6)                          /* INT6 interrupt function */
{
...
SIGNAL(SIG_INTERRUPT7)                          /* INT7 interrupt function */
{
...
int main(void)
{
  ...
  while(1)
    { switch(Key_input())                       // key input
        { case 0xE0 : PORTE &= 0xBF;            // if SW1, generate INT6(rising edge)
                      PORTE |= 0x40;
                      break;
          case 0x70 : PORTE |= 0x80;            // if SW4, generate INT7(falling edge)
                      PORTE &= 0x7F;
                      break;
          default:    break;
        }
