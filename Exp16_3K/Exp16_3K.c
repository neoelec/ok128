...
{ unsigned char i, x;
  ...
  GLCD_string(0,0,"2005‘e 03¶© 01·©");          // display title
  GLCD_string(1,0," µ¡¸å  12:00:00 ");
  GLCD_string(2,0,"    (ÑÁ¶a·©)    ");
  GLCD_string(3,0,"?¸‹¡µ¥  00.0•¡");
  ...
  while(1)
    { for(i=0; i<10; i++)
        { GLCD_xy(0,0);                         // display year
          ...
          if(x<0x80) GLCD_string(1,3,"¸å");
          else       GLCD_string(1,3,"?");
          ...
          if(x == 1)      GLCD_string(2,5,"·©");
          else if(x == 2) GLCD_string(2,5,"¶©");
          else if(x == 3) GLCD_string(2,5,"ÑÁ");
          else if(x == 4) GLCD_string(2,5,"®");
          else if(x == 5) GLCD_string(2,5,"¡¢");
          else if(x == 6) GLCD_string(2,5,"‹q");
          else            GLCD_string(2,5,"É¡");
          Delay_ms(100);
        }
