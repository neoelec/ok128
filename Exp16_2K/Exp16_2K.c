...
void GLCD_8bin(unsigned char number)
...
int main(void)
{
  ...
  while (1) {
    GLCD_string(0, 0, " ** ®•¸a?? ** ");       // display 8-bit integer
    ...
    GLCD_string(0, 0, " **  ŠŠ”e  ** ");     // display multiplication table(1)
    GLCD_string(1, 0, "                ");
    ...
    GLCD_string(0, 0, "** 2¸aŸ¡ ‰³­Q **");     // display multiplication table(2)
    GLCD_string(1, 0, "                ");
