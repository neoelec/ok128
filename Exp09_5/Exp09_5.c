/* ========================================================================== */
/*	        Exp09_5.c : Variable D/A Voltage by Key Input      	      */
/* ========================================================================== */
...
{ unsigned char voltage;
  ...
  while(1)
    { switch(Key_input())                       // key input
        { case 0xE0 : voltage--;                // if SW1, decrement by 0x01
                      PORTB = voltage;
                      Dsp_voltage(voltage);
                      break;
          case 0xD0 : voltage++;                // if SW2, increment by 0x01
                      PORTB = voltage;
                      Dsp_voltage(voltage);
                      break;
          case 0xB0 : voltage -= 0x10;          // if SW3, decrement by 0x10
                      PORTB = voltage;
                      Dsp_voltage(voltage);
                      break;
          case 0x70 : voltage += 0x10;          // if SW4, increment by 0x10
                      PORTB = voltage;
                      Dsp_voltage(voltage);
                      break;
          default:    break;
